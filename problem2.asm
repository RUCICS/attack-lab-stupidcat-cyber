...
0000000000401216 <func2>:
  ...
  40122e:	48 8d 05 d3 0d 00 00 	lea    0xdd3(%rip),%rax        # 402008 <_IO_stdin_used+0x8> "I think that you should give me the right number!\n"
  ...
  40124c:	48 8d 05 e8 0d 00 00 	lea    0xde8(%rip),%rax        # 40203b <_IO_stdin_used+0x3b>  "Yes!I like ICS!\n"
...
000000000040126a <fucc>:
  ...
  401276:	89 7d fc             	mov    %edi,-0x4(%rbp) # 帧底放置edi=1
  401279:	48 8d 05 cc 0d 00 00 	lea    0xdcc(%rip),%rax        # 40204c <_IO_stdin_used+0x4c>  "Welcome to the second level!\n"
...
0000000000401290 <func>:
  ...
  4012b3:	e8 38 fe ff ff       	call   4010f0 <memcpy@plt> # 注入点
  4012b8:	90                   	nop
  4012b9:	c9                   	leave
  4012ba:	c3                   	ret
...
00000000004012cc <main>:
  ...
  4012db:	89 bd dc fe ff ff    	mov    %edi,-0x124(%rbp) # 文件数量
  4012e1:	48 89 b5 d0 fe ff ff 	mov    %rsi,-0x130(%rbp) # 文件名称
  4012e8:	48 8d 05 7b 0d 00 00 	lea    0xd7b(%rip),%rax        # 40206a <_IO_stdin_used+0x6a>  "Do you like ICS?\n"
  ...
  401316:	48 8d 0d 5f 0d 00 00 	lea    0xd5f(%rip),%rcx        # 40207c <_IO_stdin_used+0x7c> "Usage: %s <file>\n"
  ...
  401337:	48 8b 85 d0 fe ff ff 	mov    -0x130(%rbp),%rax # 文件数量为2跳转至此 rax = 文件名字符串数组
  40133e:	48 83 c0 08          	add    $0x8,%rax
  401342:	48 8b 00             	mov    (%rax),%rax # txt文件
  401345:	48 8d 15 42 0d 00 00 	lea    0xd42(%rip),%rdx        # 40208e <_IO_stdin_used+0x8e> "r"
  40134c:	48 89 d6             	mov    %rdx,%rsi
  40134f:	48 89 c7             	mov    %rax,%rdi
  401352:	e8 a9 fd ff ff       	call   401100 <fopen@plt> # r模式打开file
  401357:	48 89 45 f8          	mov    %rax,-0x8(%rbp) # return value
  40135b:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
  401360:	75 19                	jne    40137b <main+0xaf>
  401362:	48 8d 05 27 0d 00 00 	lea    0xd27(%rip),%rax        # 402090 <_IO_stdin_used+0x90> "fopen"
  401369:	48 89 c7             	mov    %rax,%rdi
  40136c:	e8 9f fd ff ff       	call   401110 <perror@plt>
  401371:	b8 01 00 00 00       	mov    $0x1,%eax
  401376:	e9 a3 00 00 00       	jmp    40141e <main+0x152> # 错误退出
  40137b:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx # 跳转至此 rdx = ret val
  40137f:	48 8d 85 e0 fe ff ff 	lea    -0x120(%rbp),%rax # 栈上地址
  401386:	48 89 d1             	mov    %rdx,%rcx # rcx = ret val
  401389:	ba 00 01 00 00       	mov    $0x100,%edx # edx = 0x100
  40138e:	be 01 00 00 00       	mov    $0x1,%esi # esi = 1
  401393:	48 89 c7             	mov    %rax,%rdi # rdi = 栈上地址
  401396:	e8 15 fd ff ff       	call   4010b0 <fread@plt> # 返回成功读取元素数量(size_t)
  40139b:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
  40139f:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
  4013a4:	75 22                	jne    4013c8 <main+0xfc>
  4013a6:	48 8d 05 e9 0c 00 00 	lea    0xce9(%rip),%rax        # 402096 <_IO_stdin_used+0x96> "fread"
  ...
  4013c6:	eb 56                	jmp    40141e <main+0x152> # 错误退出
  4013c8:	48 8d 95 e0 fe ff ff 	lea    -0x120(%rbp),%rdx # 跳转至此 rdx = 栈上地址
  4013cf:	48 8b 45 f0          	mov    -0x10(%rbp),%rax # ret val
  4013d3:	48 01 d0             	add    %rdx,%rax 
  4013d6:	c6 00 00             	movb   $0x0,(%rax) # rax
  ...
  4013ec:	8b 45 ec             	mov    -0x14(%rbp),%eax # eax = 1
  4013ef:	89 c7                	mov    %eax,%edi # edi = 1
  4013f1:	e8 74 fe ff ff       	call   40126a <fucc> # call funcc
  4013f6:	48 8d 85 e0 fe ff ff 	lea    -0x120(%rbp),%rax 
  4013fd:	48 89 c7             	mov    %rax,%rdi # rdi = rbp - 0x120 就是文件里的字符串
  401400:	e8 8b fe ff ff       	call   401290 <func> # call func 参数为输入文件的字符串
  401405:	48 8d 05 90 0c 00 00 	lea    0xc90(%rip),%rax        # 40209c <_IO_stdin_used+0x9c>  "You don't like it! You fail!\n"
